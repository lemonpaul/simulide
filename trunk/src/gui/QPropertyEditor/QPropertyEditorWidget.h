...
public:
	...
	virtual ~QPropertyEditorWidget();
        ...
        static QPropertyEditorWidget * self() { return m_pSelf; }
	...
	void updateObject(QObject* propertyObject);
        ...
        void removeObject(QObject* propertyObject);
...
private:
        ...
        static QPropertyEditorWidget * m_pSelf;

        // The Model for this view
        QPropertyModel*                m_model;

        // The object actually displayed
