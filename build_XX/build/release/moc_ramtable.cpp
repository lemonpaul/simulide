...
QT_MOC_LITERAL(3, 23, 10), // "loadVarSet"
QT_MOC_LITERAL(4, 34, 10), // "saveVarSet"
QT_MOC_LITERAL(5, 45, 10), // "addToWatch"
QT_MOC_LITERAL(6, 56, 17) // "QTableWidgetItem*"

    },
    "RamTable\0updateValues\0\0loadVarSet\0"
    "saveVarSet\0addToWatch\0QTableWidgetItem*"
};
...
void RamTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->loadVarSet(); break;
        case 2: _t->saveVarSet(); break;
        case 3: _t->addToWatch((*reinterpret_cast< QTableWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject RamTable::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_RamTable.data,
      qt_meta_data_RamTable,  qt_static_metacall, nullptr, nullptr}
};
